  ...
  return (
    <Layout className='w-full h-[100%] bg-white'>
      <div className='p-[8px] lg:p-[0px] xl:p-[30px] xl:mx-[130px] '>
        <div className='flex flex-col lg:mt-[-50px] mt-[60px]  w-full lg:h-[720px]  2xl:mt-[100px] lg:flex-row items-center lg:w-[80%] lg:mx-auto  lg:p-[0px] '>
          <div className=' w-full lg:mt-[0px] mt-[15px] md:w-[80%] lg:w-[100%]  xl:w-[50%]  md:pl-[0px] lg:text-left  md:text-center xl:text-left'>
            <div className='lg:mb-[15px] w-full'>
              <p className='font-bold lg:text-3xl 2xl:text-5xl text-black md:text-2xl text-base w-full whitespace-nowrap'>
                hello, ar과 함께 하는
              </p>
              <p className='font-bold lg:text-3xl md:text-2xl 2xl:text-5xl text-black  text-base w-full whitespace-nowrap'>
                AR 커머스의 시작
              </p>
            </div>
            <div>
              <p className='font-medium lg:text-sm md:text-sm 2xl:text-xl break-all text-xs text-Hblack w-full whitespace-nowrap'>
                이미지, 글만 보고 제품을 상상해서 구매했던 시대는 이제 NO
              </p>
              <p className='font-medium lg:text-sm md:text-sm break-all 2xl:text-xl text-Hblack whitespace-nowrap '>
          ...
          <div className='w-full md:pl-[0px] p-[10px] lg:p-[0px]  lg:flex lg:justify-end  xl:flex xl:justify-end'>
            <img
              src={mockup}
              alt='mockup'
              className=' md:w-[100%]  w-[100%] xl:w-[80%] 2xl:w-full '
            />
          </div>
        </div>
        <div className='md:mb-[50px] lg:mb-[10px] 2xl:mb-[300px] xl:mb-[136px]'></div>
        <div className='flex  flex-col-reverse  mt-[15px] lg:flex-row  items-center w-full lg:w-[80%] lg:mx-auto  lg:p-[0px]'>
          <div className='w-[100%]  md:pl-[0px] lg:text-left  md:text-center xl:text-left'>
            <div className='lg:mb-[10px] mt-[10px] xl:mt-[0px]'>
              <p className='text-hblue 2xl:text-lg'>손쉬운 파일 등록</p>
            </div>
            <div className='lg:mb-[15px] mt-[10px]'>
              <p className='font-bold lg:text-3xl 2xl:text-4xl text-xl break-all text-black whitespace-nowrap'>
                내 제품은 내 손으로 직접 관리
              </p>
              <p className='font-bold lg:text-3xl  2xl:text-4xl text-xl break-all text-black whitespace-nowrap'>
                할 수 있도록
            ...
            <div className='mt-[10px]'>
              <p className='font-medium text-sm break-all text-Hblack 2xl:text-xl whitespace-nowrap'>
        ...
        <div className='md:mb-[120px] lg:mb-[200px]  2xl:mb-[300px] 2xl:mt-[500px]  xl:mb-[236px] mt-[50px] lg:mt-[0px]'></div>
          ...
          <div className='w-full xl:w-[50%]  mt-[10px] xl:p-[10px] lg:mt-[0px] md:pl-[0px] md:text-center lg:text-left  lg:flex lg:justify-end xl:justify-center  xl:text-left  '>
            <div>
              <div className='lg:mb-[10px] mb-[10px]'>
                <p className='text-sm text-hpurple 2xl:text-xl break-all'>
                  실제와 가까운 제품 확인을 위해
                </p>
              </div>
              <div className='lg:mb-[15px] mt-[10px] lg:mt-[0px]'>
                <p className='font-bold lg:text-3xl 2xl:text-5xl text-xl whitespace-nowrap break-all text-black'>
                  하나의 제품이라도 다른
                </p>
                <p className='font-bold lg:text-3xl 2xl:text-5xl text-xl  whitespace-nowrap break-all text-black'>
                  사이즈, 칼라, 소재를 모두 담아
              ...
              <div className='mt-[10px] mb-[10px] lg:mt-[0px] lg:mb-[0px]'>
                <p className='font-medium lg:text-sm break-all text-Hblack 2xl:text-xl whitespace-nowrap'>
        ...
        <div className='xl:mb-[200px] lg:mb-[200px] 2xl:mt-[500px]'></div>
        <div className='flex  flex-col-reverse lg:flex-row items-center lg:w-[80%] lg:mx-auto  lg:p-[0px] '>
          <div className='w-[100%]  xl:text-left  mt-[20px] md:text-center lg:text-left '>
            <div className='lg:mb-[10px] mt-[10px] lg:mt-[0px] '>
              <p className='text-sm text-htgreen 2xl:text-lg'>
                AR 서비스 애널리틱스
              </p>
            </div>
            <div className='lg:mb-[15px] mt-[10px] lg:mt-[0px] '>
              <p className='font-bold lg:text-3xl text-black 2xl:text-3xl whitespace-nowrap'>
                지금보다 더 나은 쇼핑몰이
              </p>
        ...
        <div className='md:mb-[120px] xl:mb-[200px] mb-[50px] 2xl:mt-[400px]'></div>
        ...
        <div className='md:mb-[107px] xl:mb-[237px] mt-[80px] 2xl:mb-[300px] lg:mt-[0px]'></div>
          ...
          <div className='lg:absolute  mx-auto top-0 left-0 w-[80%] lg:w-full h-full flex items-center justify-center'>
            <div className='p-5 w-fit'>
              ...
              <div className='bg-hblue w-full lg:w-fit justify-center flex lg:flex-row p-[6px] lg:items-center  mx-auto  '>
                <p
                  className='font-medium text-sm text-white break-all hover:cursor-pointer'
                  onClick={() => navigate('/qa')}
                >
                  공지 사항 및 자주 묻는 질문
                </p>
