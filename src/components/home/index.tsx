    ...
    <Layout className='w-full h-[100%] bg-white'>
      <div className='p-[8px] lg:p-[0px] '>
        <div className='flex flex-col lg:mt-[-50px] mt-[60px]  w-full lg:h-[720px] lg:flex-row items-center lg:w-[80%] lg:mx-auto  lg:p-[0px] '>
          <div className=' w-full lg:mt-[0px] mt-[15px] md:w-[80%] lg:w-[57%]  md:pl-[0px] xl:pl-[250px]  md:text-center xl:text-left'>
          ...
          <div className='w-full md:pl-[0px] xl:pl-[10px] p-[10px] lg:p-[0px]'>
        ...
        <div className='flex  flex-col-reverse  mt-[15px] lg:flex-row  items-center w-full lg:w-[80%] lg:mx-auto  lg:p-[0px]'>
          <div className='w-[100%]  md:pl-[0px] xl:pl-[250px] md:text-center xl:text-left'>
          ...
          <div className='w-[70%] xl:w-[100%] md:w-[60%]  md:pl-[0px] xl:pl-[100px] mb-[30px] mt-[20px] lg:mt-[0px]  lg:mb-[0px]'>
            <img
              src={imageOne}
              alt='imageOne'
        ...
        <div className='flex  flex-col w-full  lg:flex-row items-center lg:w-[80%] lg:mx-auto  lg:p-[0px] '>
          <div className='md:w-[50%] xl:w-[65%] w-[100%] xl:pl-[250px] mb-[50px] lg:mb-[0px]'>
          ...
          <div className='w-full  mt-[10px] lg:mt-[0px] md:pl-[0px] md:text-center  xl:text-left  xl:pl-[300px]'>
        ...
        <div className='xl:mb-[200px]'></div>
        <div className='flex  flex-col-reverse lg:flex-row items-center lg:w-[80%] lg:mx-auto  lg:p-[0px] '>
          <div className='w-[100%] xl:pl-[250px] xl:text-left  mt-[20px] md:text-center '>
          ...
          <div className='w-[50%] xl:w-full md:w-full xl:pl-[100px]  md:flex md:justify-center xl:justify-start  md:text-center xl:text-left  md:pl-[0px] mt-[50px] lg:mt-[0px]'>
            <img
              src={imagethree}
              alt='imagethre'
              className=' md:w-[40%] xl:w-[50%] w-full '
            />
          </div>
        </div>
        ...
        <div className='flex  flex-col lg:flex-row lg:items-center lg:w-[80%] w-full lg:mx-auto  lg:p-[0px]'>
          <div className='w-[100%]  flex flex-col items-center '>
            <div className='md:pl-[0px] mb-[60px] lg:mb-[0px] xl:pl-[200px] '>
            ...
            <div className='w-full md:pl-[0px] xl:pl-[250px] lg:mt-[40px] md:text-center xl:text-left'>
          ...
          <div className='w-[100%] flex flex-col items-center mt-[100px] lg:mt-[0px] md:pl-[20px]'>
            <div className=' md:pr-[0px] xl:pr-[330px] mb-[30px] lg:mb-[0px] '>
            ...
            <div className='w-full lg:pl-[0px] lg:mt-[40px] md:text-center xl:text-left '>
              <div className='lg:mb-[15px]'>
        ...
        <div className='lg:w-[80%] w-full lg:mx-auto'>
          <div className='md:w-[100%] xl:w-[90%] xl:pl-[250px]  w-full md:pl-[0px] border-solid border-1 border-black'>
        ...
        <div className='lg:w-[80%] w-full lg:mx-auto  lg:p-[0px]'>
          <div className='lg:w-[50%] w-full md:pl-[0px] xl:pl-[250px] mb-[20px]'>
            <p className='font-bold lg:text-3xl text-xl  text-black'>
              AR 서비스 관리는 이렇게 이용해 보세요!
            </p>
          </div>
          <div className='w-fit md:pl-[0px] xl:pl-[250px]'>
            <p className='font-medium lg:text-sm text-xs break-all text-Hblack'>
        ...
        <div className='lg:w-[80%] w-full lg:mx-auto  lg:p-[0px]'>
          <div className='lg:w-[50%] w-full md:pl-[0px] xl:pl-[250px] lg:mb-[20px]  '>
        ...
        <div className='md:w-[100%] xl:w-[80%] w-full lg:mx-auto  lg:p-[0px] '>
          <div className='md:pl-[0px] xl:pl-[180px] '>
